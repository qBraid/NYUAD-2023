...
circ.append(RBSGate(param=params[0]), [qubit[0], qubit[1]])

# Apply X gate2 to 3nd qubits.
circ.append(XGate(), [qubit[2]]) 
# Apply RBS gate2 to 2nd and 3rd qubit
# theta2
circ.append(RBSGate(param=params[1]), [qubit[1], qubit[2]])

# Apply X gate3 to 4th qubits.
circ.append(XGate(), [qubit[3]]) 
# Apply RBS gate3 to 1st and 2nd qubit
# theta3
circ.append(RBSGate(param=params[2]), [qubit[0], qubit[1]])

# Apply X gate4 to 5th qubits.
circ.append(XGate(), [qubit[4]]) 
# Apply RBS gate4 to 3rd and 4th qubit
# theta4
circ.append(RBSGate(param=params[3]), [qubit[2], qubit[3]])

# Apply X gate5 to 6th qubits.
circ.append(XGate(), [qubit[5]]) 
# Apply RBS gate5 to 2nd and 3rd qubit
# theta5
circ.append(RBSGate(param=params[4]), [qubit[1], qubit[2]])
# Apply RBS gate7 to 4th and 5th qubit
# theta7
circ.append(RBSGate(param=params[6]), [qubit[3], qubit[4]])

# Apply X gate6 to 7th qubits.
circ.append(XGate(), [qubit[6]]) 
# Apply RBS gate6 to 1st and 2nd qubit
# theta6
circ.append(RBSGate(param=params[5]), [qubit[0], qubit[1]])
# Apply RBS gate8 to 3rd and 4th qubit
# theta8
circ.append(RBSGate(param=params[7]), [qubit[2], qubit[3]])
# Apply RBS gate11 to 5th and 6th qubit
# theta11
circ.append(RBSGate(param=params[10]), [qubit[4], qubit[5]])

# Apply RBS gate9 to 2nd and 3rd qubit
# theta9
circ.append(RBSGate(param=params[8]), [qubit[1], qubit[2]])
# Apply RBS gate12 to 4th and 5th qubit
# theta12
circ.append(RBSGate(param=params[11]), [qubit[3], qubit[4]])
# Apply RBS gate16 to 6th and 7th qubit
# theta16
circ.append(RBSGate(param=params[15]), [qubit[5], qubit[6]])

# Apply RBS gate10 to 1st and 2nd qubit
# theta10
circ.append(RBSGate(param=params[9]), [qubit[0], qubit[1]])
# Apply RBS gate13 to 3rd and 4th qubit
# theta13
circ.append(RBSGate(param=params[12]), [qubit[2], qubit[3]])
# Apply RBS gate17 to 5th and 6th qubit
# theta17
circ.append(RBSGate(param=params[16]), [qubit[4], qubit[5]])
# Apply RBS gate22 to 7th and 8th qubit
# theta22
circ.append(RBSGate(param=params[21]), [qubit[6], qubit[7]])

# Apply RBS gate14 to 2nd and 3rd qubit
# theta14
circ.append(RBSGate(param=params[13]), [qubit[1], qubit[2]])
# Apply RBS gate18 to 4th and 5th qubit
# theta18
circ.append(RBSGate(param=params[17]), [qubit[3], qubit[4]])
# Apply RBS gate23 to 6th and 7th qubit
# theta23
circ.append(RBSGate(param=params[22]), [qubit[5], qubit[6]])

# Apply RBS gate15 to 1st and 2nd qubit
# theta15
circ.append(RBSGate(param=params[14]), [qubit[0], qubit[1]])
# Apply RBS gate19 to 3th and 4th qubit
# theta19
circ.append(RBSGate(param=params[18]), [qubit[2], qubit[3]])
# Apply RBS gate24 to 5th and 6th qubit
# theta24
circ.append(RBSGate(param=params[23]), [qubit[4], qubit[5]])

# Apply RBS gate20 to 2nd and 3rd qubit
# theta20
circ.append(RBSGate(param=params[19]), [qubit[1], qubit[2]])
# Apply RBS gate25 to 4th and 5th qubit
# theta25
circ.append(RBSGate(param=params[24]), [qubit[3], qubit[4]])

# Apply RBS gate21 to 1st and 2nd qubit
# theta21
circ.append(RBSGate(param=params[20]), [qubit[0], qubit[1]])
# Apply RBS gate26 to 3rd and 4th qubit
# theta26
circ.append(RBSGate(param=params[25]), [qubit[2], qubit[3]])

# Apply RBS gate27 to 2nd and 3rd qubit
# theta27
circ.append(RBSGate(param=params[26]), [qubit[1], qubit[2]])

# Apply RBS gate28 to 1st and 2nd qubit
# theta28
circ.append(RBSGate(param=params[27]), [qubit[0], qubit[1]])
